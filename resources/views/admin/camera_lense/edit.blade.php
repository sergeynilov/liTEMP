            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                ...
                <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item">
                            <a class="link-fx" href="{{ route('camera_lenses.index') }}">{{ __('Список ярлыков') }}</a>
                        </li>
    ...
    <div class="content">
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
                ...
                <form action="{{ route(  'camera_lers.' . ( $is_insert ? 'store' : 'update' ) , $tagData->id ?? null ) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="m-2">
                                <a type="button" href="{{ route('camera_lenses.index') }}" class="btn btn-secondary">
                                    {{ __('Отмена') }}
                                </a>
                            </div>
                            <div class="m-2">
