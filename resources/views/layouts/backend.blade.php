            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        {{--                    <li class="nav-main-heading">{{ config('app.name') }}</li>--}}
                        ...
                        <li class="nav-main-heading">{{ __('Содержимое') }}</li>

                        <li class="nav-main-item open">
                            <a class="nav-main-link {{ ( Route::currentRouteName() == 'compilations.index' or Route::currentRouteName() == 'compilations.edit' )  ? ' active_nav_menu' : '' }}"
                               href="{{ route('compilations.index') }}">
                                <i class="nav-main-link-icon si si-globe"></i>
                                <span class="nav-main-link-name">{{ __('Подборки') }}</span>
                            </a>
                        </li>

                        <li class="nav-main-item open">
                            <a class="nav-main-link {{ ( Route::currentRouteName() == 'tags.index' or Route::currentRouteName() == 'tags.edit' ) ? ' active_nav_menu' : '' }}"
                               href="{{ route('tags.index') }}">
                                <i class="nav-main-link-icon si si-globe"></i>
                                <span class="nav-main-link-name">{{ __('Теги') }}</span>
                            </a>
                        </li>

                        <li class="nav-main-item open">
                            <a class="nav-main-link {{ ( Route::currentRouteName() == 'nominations.index' or Route::currentRouteName() == 'nominations.edit' ) ? ' active_nav_menu' : '' }}"
                               href="{{ route('nominations.index') }}">
                                <i class="nav-main-link-icon si si-globe"></i>
                                <span class="nav-main-link-name">{{ __('Номинации') }}</span>
                            </a>
                        </li>

                        <li class="nav-main-item open">
                            <a class="nav-main-link {{ ( Route::currentRouteName() == 'photos_filter_index' or  Route::currentRouteName() == 'photos_filter' or Route::currentRouteName() == 'photos.index' or Route::currentRouteName() == 'photos.edit' )  ? ' active_nav_menu' : '' }}"
                               href="{{ route('photos.index') }}">
                                <i class="nav-main-link-icon si si-globe"></i>
                                <span class="nav-main-link-name">{{ __('Фотографии') }}</span>
                            </a>
                        </li>

                        <li class="nav-main-item open">
                            <a class="nav-main-link {{ ( Route::currentRouteName() == 'new_photos_filter_index' or Route::currentRouteName() == 'get_new_photos_filter'  or Route::currentRouteName() == 'new_photos_filter' )   ? ' active_nav_menu' : '' }}"
                               href="{{ route('new_photos_filter_index') }}">
                                <i class="nav-main-link-icon si si-globe"></i>
                                <span class="nav-main-link-name">{{ __('Свежие фото') }}</span>
                            </a>
                        </li>
    ...
    <header id="page-header">
        ...
        <div class="content-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <form class="d-none d-md-inline-block" action="/admin/dashboard" method="POST">
                    @csrf
                    ...
                    <div class="dropdown d-inline-block ms-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0"
                            ...
                            <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                                ...
                                <p class="mb-0 text-muted fs-sm fw-medium">{{ getLoggedUserPermissionsLabel() }}</p>
                            </div>
                            <div class="p-2">
        ...
        <div id="page-header-search" class="overlay-header bg-body-extra-light">
            <div class="content-header">
                <form class="w-100" action="/admin/dashboard" method="POST">
                    @csrf
        ...
        <div class="content py-3">
            <div class="row fs-sm">
                ...
                <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                    <a class="fw-semibold" href="https://1.envato.market/AVD6j" target="_blank">{{ config('app.name') }}</a> &copy; <span
